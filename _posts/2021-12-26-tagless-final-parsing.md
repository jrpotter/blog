...
[InfixL](https://hackage.haskell.org/package/parser-combinators-1.3.0/docs/src/Control.Monad.Combinators.Expr.html#pInfixL)'s
parser:
...
explicit sharing as noted [here](/assets/pdf/tagless-final-parsing/kiselyov-embedded.pdf),
