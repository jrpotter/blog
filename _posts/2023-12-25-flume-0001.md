...
[Supabase](/snapshots/flume-0001/supabase){:target="_blank"} introduced. In
general, direct user-to-database communication is not a paradigm I agree with
and the need to think about [RLS](/snapshots/flume-0001/rls){:target="_blank"}
...
arbitrary data, running these functions in [V8](/snapshots/flume-0001/v8){:target="_blank"}
